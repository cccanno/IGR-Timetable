...
var itinoheData = [
	{template: "kozuyaTemplate", time: {text: "6:40"}, lastStation: {text: "[八]鮫（八戸経由）"}, rate: 640, lag: {}},
	{template: "kozuyaTemplate", time: {text: "7:50"}, lastStation: {text: "八戸"}, rate: 750, lag: {}},
	{template: "kozuyaTemplate", time: {text: "8:35"}, lastStation: {text: "二戸"}, rate: 835, lag: {}},
	{template: "kozuyaTemplate", time: {text: "10:13"}, lastStation: {text: "八戸"}, rate: 1013, lag: {}},
	{template: "kozuyaTemplate", time: {text: "11:23"}, lastStation: {text: "八戸"}, rate: 1123, lag: {}},
	{template: "kozuyaTemplate", time: {text: "13:00"}, lastStation: {text: "八戸"}, rate: 1300, lag: {}},
	{template: "kozuyaTemplate", time: {text: "14:15"}, lastStation: {text: "八戸"}, rate: 1415, lag: {}},
	{template: "kozuyaTemplate", time: {text: "15:11"}, lastStation: {text: "八戸"}, rate: 1511, lag: {}},
	{template: "kozuyaTemplate", time: {text: "16:25"}, lastStation: {text: "八戸"}, rate: 1625, lag: {}},
	{template: "kozuyaTemplate", time: {text: "17:25"}, lastStation: {text: "金田一温泉"}, rate: 1725, lag: {}},
	{template: "kozuyaTemplate", time: {text: "18:07"}, lastStation: {text: "八戸"}, rate: 1807, lag: {}},
	{template: "kozuyaTemplate", time: {text: "19:19"}, lastStation: {text: "八戸"}, rate: 1919, lag: {}},
	{template: "kozuyaTemplate", time: {text: "20:12"}, lastStation: {text: "八戸"}, rate: 2012, lag: {}},
	{template: "kozuyaTemplate", time: {text: "21:22"}, lastStation: {text: "八戸"}, rate: 2122, lag: {}},
	{template: "kozuyaTemplate", time: {text: "22:50"}, lastStation: {text: "八戸"}, rate: 2250, lag: {}}
];
$.itinoheListSection.setItems(itinoheData);

var ninoheData = [
	{template: "kozuyaTemplate", time: {text: "6:46"}, lastStation: {text: "[八]鮫（八戸経由）"}, rate: 646, lag: {}},
	{template: "kozuyaTemplate", time: {text: "7:56"}, lastStation: {text: "八戸"}, rate: 756, lag: {}},
	{template: "kozuyaTemplate", time: {text: "10:19"}, lastStation: {text: "八戸"}, rate: 1019, lag: {}},
	{template: "kozuyaTemplate", time: {text: "11:29"}, lastStation: {text: "八戸"}, rate: 1129, lag: {}},
	{template: "kozuyaTemplate", time: {text: "13:06"}, lastStation: {text: "八戸"}, rate: 1306, lag: {}},
	{template: "kozuyaTemplate", time: {text: "14:21"}, lastStation: {text: "八戸"}, rate: 1421, lag: {}},
	{template: "kozuyaTemplate", time: {text: "15:16"}, lastStation: {text: "八戸"}, rate: 1516, lag: {}},
	{template: "kozuyaTemplate", time: {text: "16:31"}, lastStation: {text: "八戸"}, rate: 1631, lag: {}},
	{template: "kozuyaTemplate", time: {text: "17:30"}, lastStation: {text: "金田一温泉"}, rate: 1730, lag: {}},
	{template: "kozuyaTemplate", time: {text: "17:49"}, lastStation: {text: "八戸"}, rate: 1749, lag: {}},
	{template: "kozuyaTemplate", time: {text: "18:12"}, lastStation: {text: "八戸"}, rate: 1812, lag: {}},
	{template: "kozuyaTemplate", time: {text: "19:24"}, lastStation: {text: "八戸"}, rate: 1924, lag: {}},
	{template: "kozuyaTemplate", time: {text: "20:17"}, lastStation: {text: "八戸"}, rate: 2017, lag: {}},
	{template: "kozuyaTemplate", time: {text: "21:28"}, lastStation: {text: "八戸"}, rate: 2128, lag: {}},
	{template: "kozuyaTemplate", time: {text: "22:55"}, lastStation: {text: "八戸"}, rate: 2255, lag: {}}
];
